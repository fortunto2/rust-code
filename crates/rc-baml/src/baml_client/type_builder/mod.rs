...
impl TypeBuilder {
    ...
    /// Access the `DependenciesTool` class builder.
    pub fn DependenciesTool(&self) -> DependenciesToolClassBuilder {
        DependenciesToolClassBuilder::new(
            self.inner
                .get_class("DependenciesTool")
                .expect("class DependenciesTool is defined in schema"),
        )
    }
    ...
    /// Access the `ProjectMapTool` class builder.
    pub fn ProjectMapTool(&self) -> ProjectMapToolClassBuilder {
        ProjectMapToolClassBuilder::new(
            self.inner
                .get_class("ProjectMapTool")
                .expect("class ProjectMapTool is defined in schema"),
        )
    }
    ...
    /// Access the `TaskTool` class builder.
    pub fn TaskTool(&self) -> TaskToolClassBuilder {
        TaskToolClassBuilder::new(
            self.inner
                .get_class("TaskTool")
                .expect("class TaskTool is defined in schema"),
        )
    }
